...
function sendHTTP() {
     ...
     mac = deviceInfo.mac;
     console.log(mac);
     if (qqtoken!=""&&qqtoken!=null) {
        third_user_id_pay = qqtoken;
     }
     else third_user_id_pay = "";
     var str = '{"sid":"aabbccc","user_id":"' +user_id_pay+ '","user_flag":2,"third_user_id":"' +third_user_id_pay+ '","product_id":24,"product_type":"6","movie_id":"","source_id":1,"source_sign":"yinhe","client_type":1,"mac":"' +mac+ '","title":"1个星期","price":100,"count":1}';     // console.log(str);
    console.log('--------------------hello-------------------');
    console.log(str);
    $.ajax({
